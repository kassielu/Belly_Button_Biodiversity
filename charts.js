...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    //console.log(result);
    var xticks = sample_values.map((val) =>parseInt(val)).slice(0,10).reverse();
    //console.log(xticks);
    var yticks = otu_ids.slice(0,10).map((oi) =>"OTU " + oi).reverse();
    //console.log(yticks);
    var barHoverText = otu_labels.slice(0,10).reverse();
